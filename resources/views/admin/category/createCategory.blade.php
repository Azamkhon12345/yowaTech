...
<style>
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Добавление категории
                        <div class="page-title-subheading">Здесь вы можете добавить новую категорию.
    ...
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">Добавление категории</h5>
...
{{--                        <input type="checkbox" name="onMain" class="form-control mycheck">--}}
{{--                    </div>--}}
{{--                </div>--}}
