    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Новости
                    <div class="page-title-subheading">Здесь вы можете добавлять, редактировать и удалять новости.
                    </div>
                </div>
            </div>
            <div class="page-title-actions">
                <div class="d-inline-block dropdown btn btn-amber">
                        <a href="/admin/news/create" class=" mb-2 mr-2 btn-hover-shine btn btn-primary"> Создать новость</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="">
            <div class="">
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">Новости на сайте</h5>
                        <br>
                        <style>
                            .fullw {
                                width: 100% !important;
